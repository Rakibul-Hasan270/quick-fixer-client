...
const Card = ({ item }) => {
    const { title, image, description, totalProviders, averageRating, category, serviceCharge, name } = item;
    // console.log(item);


    return (
        <Link to='/' className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
            {/* <img
