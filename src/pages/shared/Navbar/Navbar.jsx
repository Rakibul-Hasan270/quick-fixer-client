...
const Navbar = () => {
    ...
    const links = <div className='md:flex items-end justify-center'>
        ...
        <li><NavLink to="/services" className={({ isActive }) => isActive ? "text-cyan-400 font-bold underline" : "text-cyan-500"}>Services</NavLink></li>
    ...
    return (
        <div className="max-w-6xl mx-auto navbar bg-base-100 shadow-sm">
            <div className="navbar-start">
                ...
                <Link to='/' className="btn btn-ghost text-xl">Quick<span className='text-cyan-500'>Fixer</span></Link>
            </div>
